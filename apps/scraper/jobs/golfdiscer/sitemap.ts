...
async function scrapeGolfDiscerSitemap() {
  const baseUrl = "https://GolfDiscer.no";
  const name = "GolfDiscer";
  const slug = "GolfDiscer";
  ...
  try {
    ...
    logger.error("GolfDiscer scraping error:", error);
  } finally {
