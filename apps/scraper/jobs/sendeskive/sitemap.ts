...
async function scrapeSendeskiveSitemap() {
  const baseUrl = "https://sendeskive.no";
  const name = "Sendeskive";
  const slug = "sendeskive";
  ...
  try {
    ...
    logger.error("sendeskive scraping error:", error);
  } finally {
