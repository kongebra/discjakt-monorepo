...
async function scrapeStarframeSitemap() {
  const baseUrl = "https://starframe.no";
  const name = "starframe";
  const slug = "starframe";
  ...
  try {
    ...
    logger.error("starframe scraping error:", error);
  } finally {
